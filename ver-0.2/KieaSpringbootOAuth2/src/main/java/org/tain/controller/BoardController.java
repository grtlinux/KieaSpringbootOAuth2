...
public class BoardController {
	...
	public String list(Pageable pageable, @SocialUser User user, Model model) {  // Page request [number: 0, size 20, sort: UNSORTED]
		log.info("KANG-20200531 >>>>> " + CurrentInfo.get() + ":" + pageable);
